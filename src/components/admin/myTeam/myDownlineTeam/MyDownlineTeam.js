...
import { downlineGet } from '../../../../api/login/Login';
                    ...
                    <div className="card-body">
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-4">
                                    <label htmlFor="txtUserId">Select Type</label>
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >Parent ID</th>
                                        <th className="sorting" >Sponsor ID</th>
                                ...
                                <tbody>
                                    {data && data?.map((item, i) => {
                                        ...
                                        return <tr className="odd" key={item?._id}>
                                            ...
                                            <td valign="top" className="dataTables_empty">{item?.sponsor}</td>
