...
import { contestSelfDeatilsRank } from "../../../../api/login/Login";
import { useEffect, useState } from "react";




export const SelfContestRankDetails = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await contestSelfDeatilsRank(clone)
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >Pridiction</th>
                                    </tr>
                                </thead>
                                <tbody>
