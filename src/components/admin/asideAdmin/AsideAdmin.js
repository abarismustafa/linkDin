                ...
                <div id="mCSB_1" className="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style={{ maxHeight: 'none' }} tabIndex={0}><div id="mCSB_1_container" className="mCSB_container" style={{ position: 'relative', top: 0, left: 0 }} dir="ltr">
                    ...
                    {/* <div className="MenuItem">
                        <div className="card-header card-header-header" onClick={(e) => { changAllAside(e) }}>
                            <NavLink to="my-win-contest-list/Win">
                                ...
                                <span>My Win Contests List</span>
                            </NavLink>
                        </div>
                    ...
                    {/* <div className="MenuItem">
                        <div className="card-header card-header-header" onClick={(e) => { changAllAside(e) }}>
                            <NavLink to="upcomming-Contests-List/Upcomming">
                                ...
                                <span>Upcomming Contests List</span>
                            </NavLink>
                        </div>
                    ...
                    <div className="MenuItem ">
                        <div className="card-header collapsed headingSettings-2" id="headingSettings" data-toggle="collapse" data-target="#collapseSettings" aria-expanded="false" aria-controls="collapseSettings">
                            <Link href="#" onClick={() => { changeOpen(!allAside.profile, "profile"); }}>
                                <CgProfile />
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.profile ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                ...
                                <li onClick={handleMenuClick}>
                                    <NavLink to="change_txnpassword">Pin Change</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="my_kyc">my_kyc</NavLink>
                                </li>
                                {/* <li onClick={handleMenuClick}>
                                    <NavLink to="registrationComplete">Complete Kyc</NavLink>
                                </li> */}
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/User-Panel/Member/welcomeletter">Welcome Letter</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/User-Panel/Member/getIDcard">Identity Card</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="my-referred-member">New Registration</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="MenuItem ">
                        <div className="card-header collapsed headingSettings-2" id="headingSettings" data-toggle="collapse" data-target="#collapseSettings" aria-expanded="false" aria-controls="collapseSettings">
                            <Link href="#" onClick={() => { changeOpen(!allAside.binaryTree, "binaryTree"); }}>
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.binaryTree ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="my-referred-member">My Referral Members</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="my-downline-team">My Downline Report</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/User-Panel/Member/binarytree">My Bot Matching Tree</NavLink>
                                </li>
                    ...
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.flight1 ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight_booking">Flight Search</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="groupticket/request-list">Group Request</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight/bookings">My Bookings</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight/booking-calender">My Booking Calender</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight/flight-amendments">My Amendments</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight/flight-cancellatons">My Cancellations</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight/flight-refunds">My Refunds</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div> */}
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.viaggoHotel ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="hotels-search">Hotel Search</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                    ...
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.bus1 ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus-search">Bus Search</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="busgroupticket/request-list">Group Request</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus/bus-booking-list">My Bookings</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus/booking-calender">My Booking Calender</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus/bus-amendments">My Amendments</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus/bus-cancellation-list">My Cancellations</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus/refunds">My Refunds</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div> */}
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.viaggoVisa ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="visa/search">Visa Search</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                    ...
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.Holidays1 ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="holiday/search">Search Holiday</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="holiday/booking-list">My Bookings</NavLink>
                                </li>

                                <li onClick={handleMenuClick}>
                                    <NavLink to="holiday/amendments">My Amendments</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="holiday/holiday-cancellations">My Cancellations</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="holiday/refunds">My Refunds</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div> */}
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.Cruise1 ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="cruise/cruise-Search">Search Holiday</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="cruise/booking-list">My Bookings</NavLink>
                                </li>

                                <li onClick={handleMenuClick}>
                                    <NavLink to="cruise/amendments">My Amendments</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="cruise/cruise-cancellations">My Cancellations</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="cruise/refunds">My Refunds</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div> */}
                    ...
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.Accounts1 ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                
                                <li onClick={handleMenuClick}>
                                    <NavLink to="account_Ledger">Account Ledger</NavLink>
                                </li>

                                <li onClick={handleMenuClick}>
                                    <NavLink to="recharge-history">Recharge History</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="deposit-history">Deposit History</NavLink>
                                </li>
                                <li>
                                    <a href="#" onClick={handleaepsopen}>Credit Notes <i class="fas fa-chevron-right ml-2"></i> </a>
                                    <ul className={aepsOpen ? "" : "d-none"}>
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="flight-credit-notes">Flight Credit Note</NavLink>
                                        </li>
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="hotal-credit-notes">Hotel Credit Note</NavLink>
                                        </li>
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="bus-credit-notes">Bus Credit Details</NavLink>
                                        </li>
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="visa-credit-notes">Visa Credit Details</NavLink>
                                        </li>
                                    </ul>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bulk-invoice">Bulk Invoice</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="get-agent-debit-info">Debit Notes</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="gst-detail">Add GST</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="company-gst-details">My GST</NavLink>
                                </li>
                    ...
                    {/* <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.GoatAllReport1 ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                              
                                <li onClick={handleMenuClick}>
                                    <NavLink to="flight-sales-report">Flight Report</NavLink>
                                </li>

                                <li onClick={handleMenuClick}>
                                    <NavLink to="hotel-sales-report">Hotel History</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="bus-sales-report">Bus History</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="commission-report">Commission Report</NavLink>
                                </li>
                            ...
                            <div className="MenuItem ">
                                ...
                                <div id="collapseOne" className={`SubmenuItems collapse ${allAside.report ? "mm-show" : "extra"}`} >
                                    <ul>
                                        ...
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="package-payment-report">Package Purchase Report</NavLink>
                                        </li>
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="transfer-fund-report">Fund Trasfer Report</NavLink>
                                        </li>

                                        <li onClick={handleMenuClick}>
                                            <NavLink to="performance-bonus">Performance Bonus Report</NavLink>
                                        </li>
                                        <li onClick={handleMenuClick}>
                    ...
                    <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.income ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                {/* <li onClick={handleMenuClick}>
                                    <Link to="shipping_Address">Shipping Address</Link>
                                </li> */}
                                ...
                                <li onClick={handleMenuClick}>
                                    <NavLink to="referal-income">Referral Income</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/level-income">Level Income</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/reward-income">Rank & Reward</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/achivement-income">Fast Achivement Bonous</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="aibot/matching-income">Matching Bonous</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="society-income">Society Income</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="TLC-profit">Trading Profit Income</NavLink>
                                </li>

                                <li onClick={handleMenuClick}>
                                    <NavLink to="earning-cycle-bounus">Earning Cycle Bounus</NavLink>
                                </li>
