...
function PaymentRequest() {
    ...
    const [filterInitial, setFilterInitial] = useState({
        ...
        min_amt: 0,
        max_amt: 0,
        end_date: todaydate,  // Set current date as default
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" tabIndex={0} aria-controls="myTable" rowSpan={1} colSpan={1} style={{ width: '76.4px' }} aria-label="Status: activate to sort column ascending">Transaction Dispute</th>
                                    </tr>
