...
import TLC20ICOFilter from "../../../pages/TLC2.0/TLC2.0ICO/TLC2.0ICOFilter/TLC2.0ICOFilter";
    ...
    return (
        <>
            <div className="PageHeading">
                <h1>Aibot2.0 ICO Report</h1>
            </div>
            <div className="ContentArea">
                <div className="card">
                    <div className="card-header"><span>Fillter Aibot2.0 ICO</span>
