...
import TLC20ProfitFilter from "./TLC2.0ProfitFilter/TLC2.0ProfitFilter";
    ...
    return (
        <>
            <div className="PageHeading">
                <h1>AIBOT2.0 Profit</h1>
            </div>
            <div className="ContentArea">
                <div className="card">
                    <div className="card-header"><span>Fillter AIBOT2.0 Profit</span>
                    </div>
