...
import GiftDirectTLCProfitFilter from "./giftDirectTLCProfitFilter/GiftDirectTLCProfitFilter";


const GiftDirectTLCProfit = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Income",
        title_2: "Direct TLC Profit",
        path_2: ""
    };
    return (
        <>
            <div className="PageHeading">
                <h1>Direct TLC Profit</h1>
            </div>
            <div className="ContentArea">
                <div className="card">
                    <div className="card-header"><span>Fillter Direct TLC Profit</span>
                    </div>
