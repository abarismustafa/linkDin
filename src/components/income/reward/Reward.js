...
import { mlm_reward_recordGet } from '../../../api/login/Login';
...
function Reward() {
  ...
  const getTransitionReport = async (input) => {
    ...
    try {
      const res = await mlm_reward_recordGet(clone)
      // console.log(res);
  ...
  return (
    <>
      ...
      <div className="ContentArea">
        <div className="card">
          <div className="card-header"><span>Fillter Reward Income</span>
          </div>
                ...
                <table id="rechargehistorytbl" className="table table-striped table-bordered table-hover display fixed_headers dataTable" style={{ width: 1250 }} role="grid" aria-describedby="rechargehistorytbl_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th style={{ width: '150px' }}>Reward Lavel</th>
                      <th style={{ width: '150px' }}>Amount</th>
                      <th style={{ width: '150px' }}>Gift</th>
                      <th style={{ width: '150px' }}>Left PV</th>
                      <th style={{ width: '150px' }}>Right PV</th>
