...
import CompoundingProfitIncomeFilter from "./compoundingProfitIncomeFilter/CompoundingProfitIncomeFilter";


const CompoundingProfitIncome = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Income",
        title_2: "Compounding Profit Income",
        path_2: ""
    };
    return (
        <>
            <div className="PageHeading">
                <h1>Compounding Profit Income</h1>
            </div>
            <div className="ContentArea">
                <div className="card">
                    <div className="card-header"><span>Fillter Compounding Profit Income</span>
                    </div>
