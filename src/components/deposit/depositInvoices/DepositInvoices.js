...
import DepositInvoicesFilter from "./depositInvoicesFilter/DepositInvoicesFilter";
...
const DepositInvoices = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Deposit",
        title_2: "Deposit Invoices",
        path_2: ""
    };
    return (
        <>
            <div className="PageHeading">
                <h1>Deposit Invoices</h1>
            </div>
            <div className="ContentArea">
                <div className="card">
                    <div className="card-header"><span>Fillter Deposit Invoices</span>
                    </div>
