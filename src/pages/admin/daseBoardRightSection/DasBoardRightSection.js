...
function DasRightSectionPage({ tokenNoti, walletData, services }) {
    ...
    return (
        <>
            ...
            <div className="LayoutMain" ref={ref} id="abcd dadas" >
                <AdminHeader walletData={walletData} toggleSidebar2={toggleSidebar2} handleClick={handleClick} toggleSidebar={toggleSidebar} profileOn={profileOn} profileOf={profileOf} toggle={toggle} tokenNoti={tokenNoti} />
                <div className={`BodyArea ${isSidebarOpen ? 'sidebar-open' : ''}`} id="abcd">
                    <AsideAdmin isActive={isActive} overlayClick={overlayClick} handleMenuClick={handleMenuClick} clickoVer={clickoVer} services={services} isSidebarOpen={isSidebarOpen} isOpen={isOpen} />
